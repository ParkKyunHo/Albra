...
class WalkForwardAnalysis:
    ...
    def plot_results(self, results: List[Dict]):
        ...
        plt.tight_layout()
        plt.savefig('hma_cross_strategy_results.png', dpi=300, bbox_inches='tight')
        print(f"\n📊 Results saved to: hma_cross_strategy_results.png")
        plt.show()


if __name__ == "__main__":
    # Walk-Forward Analysis 실행
    wfa = WalkForwardAnalysis(TrendFollowingHMACrossStrategy)
    wfa.run()